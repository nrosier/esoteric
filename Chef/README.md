...
## Could you actually bake it?

Chef's design principles insist recipes be genuinely preparable, and this one is
*almost* honest: flour, sugar and raisins are a real start on a fruitcake. The
nutmeg oil, quince juice and sparkling water, though, are in the list purely
because 78, 63 and 32 are `N`, `?` and a space. Bake at your own risk. The
recipe serves 1, which — as the Hello World Souffle also cheerfully admits — is
